...
const VideoTitle = ({ movie }) => {
  ...
  return (
    <>
      <div className="w-screen aspect-video pt-[15%] px-6 md:px-24 absolute text-white bg-gradient-to-r from-black">
        ...
        <div className="flex mt-4 md:mt-2">
          ...
          <button
            ...
            className="hidden md:flex mx-2 bg-gray-500 text-white py-3 px-12 text-xl bg-opacity-50 rounded-lg hover:bg-opacity-70 transition duration-300 items-center font-bold"
          >
            <svg
              className="mr-2"
              xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Movie Details Modal — rendered via React Portal */}
      {showModal && (
        <MovieDetailsModal
          movie={movie}
